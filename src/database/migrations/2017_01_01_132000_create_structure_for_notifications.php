...
class CreateStructureForNotifications extends StructureMigration
{
    ...
    protected $permissions = [
        ...
        ['name' => 'core.notifications.markAsRead', 'description' => 'Mark notification as Read', 'type' => 1],
        ['name' => 'core.notifications.markAllAsRead', 'description' => 'Marl All notifications as Read', 'type' => 1],
